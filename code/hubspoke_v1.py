...
# Author: Takara Sakai
# Date: 2025-01-28
# Description: Demand-driven hub-and-spoke model (paper-faithful implementation, v1).
#              This is the original implementation that accompanies the paper.
#              For the improved version with Numba JIT and BB pruning, see
#              hubspoke.py (v2).
